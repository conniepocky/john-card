...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23900){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23901,G__23902,seq23900__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23906_SHARP_){
return !((cljs.core.meta.call(null,p1__23906_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23907__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23911){var _e__22666__auto__ = e23911;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e23913){var _e__22666__auto__ = e23913;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23915 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23916 = opts;
...
var markup_db = cljs.core.get.call(null,map__23916__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23915;
}});
...
;
var temp__5455__auto___23920 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23920)){
var managed_print_level_23921 = temp__5455__auto___23920;
var _STAR_print_level_STAR_23919_23922 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23921;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23919_23922,managed_print_level_23921,temp__5455__auto___23920,writer,opts,job_fn){
return (function (p1__23918_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23918_SHARP_,null);
});})(_STAR_print_level_STAR_23919_23922,managed_print_level_23921,temp__5455__auto___23920,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23919_23922;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1545477011821
