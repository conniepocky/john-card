...
var o22839 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22839["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22840 = temp__5455__auto____$1;
return (o22840["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22659__auto__ = f;
return (o__22659__auto__["toString"]).call(o__22659__auto__);
} else {
return "";
}
...
try{var o__22659__auto___22843 = t;
(o__22659__auto___22843["cljs$lang$ctorPrWriter"]).call(o__22659__auto___22843,t,writer);
}catch (e22842){var __22844 = e22842;
}
...
var char_code = (function (){var o__22659__auto__ = (new String(char$));
return (o__22659__auto__["charCodeAt"]).call(o__22659__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22659__auto__ = String;
return (o__22659__auto__["fromCharCode"]).call(o__22659__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22845 = num_code;
switch (G__22845) {
case (1):
return (185);
...
var o__22659__auto__ = String;
return (o__22659__auto__["fromCharCode"]).call(o__22659__auto__,superscript_code);
});
/**
...
}catch (e22847){var _e__22666__auto__ = e22847;
return false;
}})())){
...
var vec__22848 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22848,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22851 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22851["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22852 = temp__5455__auto____$1;
return (o22852["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22855){
var vec__22856 = p__22855;
var ns_detector = cljs.core.nth.call(null,vec__22856,(0),null);
...
var G__22862 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22863 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22862;
remaining_tokens = G__22863;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22853){
var G__22854 = cljs.core.first.call(null,seq22853);
var seq22853__$1 = cljs.core.next.call(null,seq22853);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22854,seq22853__$1);
});
...
var vec__22867 = cljs.core.split_with.call(null,(function (p1__22866_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22866_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22867,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22867,(1),null);
...
var vec__22870 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22870,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22870,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22873 = cljs.core.rest.call(null,remaining_tokens);
var G__22874 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22873;
name_tokens = G__22874;
continue;
} else {
...
var vec__22877 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22877,(0),null);
var arity = cljs.core.nth.call(null,vec__22877,(1),null);
var vec__22880 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22880,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22880,(1),null);
var vec__22883 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22883,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22883,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22883,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22883,(3),null);
...
var vec__22889 = result;
var munged_ns = cljs.core.nth.call(null,vec__22889,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22889,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22889,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22889,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22889,(4),null);
var arity = cljs.core.nth.call(null,vec__22889,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22893 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22893,(0),null);
var args = cljs.core.nth.call(null,vec__22893,(1),null);
var vec__22896 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22896,(0),null);
var name = cljs.core.nth.call(null,vec__22896,(1),null);
...
var G__22899 = (arity + (1));
var G__22900 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22901){
var vec__22902 = p__22901;
var arity = cljs.core.nth.call(null,vec__22902,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22902,(1),null);
...
return cljs.core.get.call(null,arities,p1__22905_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22906_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22909){
var vec__22910 = p__22909;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22910,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22907){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22918__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22918__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22918__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22918__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
...
var o__22659__auto__ = f;
return (o__22659__auto__["getBasis"]).call(o__22659__auto__);
});
/**
...
}catch (e22923){var _e__22666__auto__ = e22923;
...
var G__22924 = (obj[cljs.core.first.call(null,path)]);
var G__22925 = cljs.core.rest.call(null,path);
obj = G__22924;
path = G__22925;
continue;
} else {
...
return (function (accum,p__22926){
var vec__22927 = p__22926;
var bit = cljs.core.nth.call(null,vec__22927,(0),null);
var protocol = cljs.core.nth.call(null,vec__22927,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22930){
var vec__22931 = p__22930;
var ns = cljs.core.nth.call(null,vec__22931,(0),null);
var name = cljs.core.nth.call(null,vec__22931,(1),null);
var selector = cljs.core.nth.call(null,vec__22931,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22936,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22936,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22936,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22934_SHARP_){
return (obj[cljs.core.first.call(null,p1__22934_SHARP_)]);
});})(name,sorted_matches,vec__22936,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1545477010780
