...
return (new CustomEvent(event_name,(function (){var obj33593 = {"detail":data};
return obj33593;
})()));
} else {
...
var f = (function (){var pred__33600 = cljs.core._EQ_;
var expr__33601 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33600.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33601))){
return ((function (pred__33600,expr__33601){
return (function (p1__33594_SHARP_){
return console.warn(p1__33594_SHARP_);
});
;})(pred__33600,expr__33601))
} else {
if(cljs.core.truth_(pred__33600.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33601))){
return ((function (pred__33600,expr__33601){
return (function (p1__33595_SHARP_){
return console.debug(p1__33595_SHARP_);
});
;})(pred__33600,expr__33601))
} else {
if(cljs.core.truth_(pred__33600.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33601))){
return ((function (pred__33600,expr__33601){
return (function (p1__33596_SHARP_){
return console.error(p1__33596_SHARP_);
});
;})(pred__33600,expr__33601))
} else {
return ((function (pred__33600,expr__33601){
return (function (p1__33597_SHARP_){
return console.log(p1__33597_SHARP_);
});
;})(pred__33600,expr__33601))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33604){
...
var opts = map__33605__$1;
var eval_fn = cljs.core.get.call(null,map__33605__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33607_SHARP_);
});})(new_def))
);
...
return (function (p__33608){
var vec__33609 = p__33608;
var ky = cljs.core.nth.call(null,vec__33609,(0),null);
var v = cljs.core.nth.call(null,vec__33609,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1545477024589
