...
var G__27492 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27492;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27493 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27493,ch);
...
if(("\\" === ch__$1)){
var ch_27494__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27494__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27494__$2);
} else {
}

var G__27495 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27495;
continue;
}
}
...
var vec__27503 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27503,(0),null);
var start_column = cljs.core.nth.call(null,vec__27503,(1),null);
...
var G__27506 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27506;
continue;
}
}
...
var _STAR_read_delim_STAR_27507 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_27507;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27508 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27508,(0),null);
var start_column = cljs.core.nth.call(null,vec__27508,(1),null);
...
var vec__27511 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27511,(0),null);
var end_column = cljs.core.nth.call(null,vec__27511,(1),null);
...
var vec__27514 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27514,(0),null);
var start_column = cljs.core.nth.call(null,vec__27514,(1),null);
...
var vec__27517 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27517,(0),null);
var end_column = cljs.core.nth.call(null,vec__27517,(1),null);
...
var vec__27520 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27520,(0),null);
var start_column = cljs.core.nth.call(null,vec__27520,(1),null);
...
var vec__27523 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27523,(0),null);
var end_column = cljs.core.nth.call(null,vec__27523,(1),null);
...
var sb = (function (){var G__27526 = (new goog.string.StringBuffer());
G__27526.append(initch);
...
var G__27528 = (function (){var G__27527 = sb;
G__27527.append(ch);

return G__27527;
})();
var G__27529 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27528;
ch = G__27529;
continue;
}
...
switch (G__27532) {
case "\\":
var G__27536 = (function (){var G__27533 = sb;
G__27533.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27533;
})();
var G__27537 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27536;
ch = G__27537;
continue;
...
break;
default:
var G__27538 = (function (){var G__27534 = sb;
G__27534.append(ch);

return G__27534;
})();
var G__27539 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27538;
ch = G__27539;
continue;
...
var vec__27540 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27540,(0),null);
var end_column = cljs.core.nth.call(null,vec__27540,(1),null);
...
var vec__27543 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27543,(0),null);
var column = cljs.core.nth.call(null,vec__27543,(1),null);
...
var vec__27548 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27548,(0),null);
var column = cljs.core.nth.call(null,vec__27548,(1),null);
...
var vec__27553 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27553,(0),null);
var column = cljs.core.nth.call(null,vec__27553,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27558 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27558,(0),null);
var start_column = cljs.core.nth.call(null,vec__27558,(1),null);
...
var vec__27561 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27561,(0),null);
var end_column = cljs.core.nth.call(null,vec__27561,(1),null);
...
var G__27564 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27564,true,null,opts,pending_forms);
...
var G__27565 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27565)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27565)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27565)){
...
var _STAR_suppress_read_STAR_27566 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27566;
}});
...
var G__27567 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27567,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27567,rdr,first_line);
...
var G__27571 = matched;
var G__27572 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27571;
finished = G__27572;
continue;
} else {
...
var _STAR_suppress_read_STAR_27573 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27573;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env27574 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27575 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27575,"(");
...
var G__27576 = (i + (1));
var G__27577 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27574;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27578 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27578);
...
var G__27579 = cljs.core.next.call(null,s__$1);
var G__27580 = ret;
s__$1 = G__27579;
r = G__27580;
continue;
...
var G__27581 = cljs.core.next.call(null,s);
var G__27582 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27581;
key_vals = G__27582;
continue;
} else {
...
var gensym_env27586 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27586;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27587 = token;
var G__27587__$1 = (((G__27587 == null))?null:cljs.core.subs.call(null,G__27587,(1)));
var G__27587__$2 = (((G__27587__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27587__$1));
var G__27587__$3 = (((G__27587__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27587__$2));
var G__27587__$4 = (((G__27587__$3 == null))?null:cljs.core.symbol.call(null,G__27587__$3));
if((G__27587__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27587__$4);
}
})():(function (){var G__27588 = token;
var G__27588__$1 = (((G__27588 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27588));
if((G__27588__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27588__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e27595){if((e27595 instanceof Error)){
var e = e27595;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27599,reader){
...
var eof = cljs.core.get.call(null,map__27600__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27606){
var G__27607 = cljs.core.first.call(null,seq27606);
var seq27606__$1 = cljs.core.next.call(null,seq27606);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27607,seq27606__$1);
});


//# sourceMappingURL=reader.js.map?rel=1545477019357
